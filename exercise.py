...
def implement_compare_models(prompt):
    ...
    """
    model1 = implement_llama_4_model()
    model2 = implement_llama_3_3_model()
    dictionary = {
        model1: implement_query_model(model1, prompt),
        model2: implement_query_model(model2, prompt)
    }
